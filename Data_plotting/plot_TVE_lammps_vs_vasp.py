#!/usr/bin/env python3
"""Plot thermodynamic properties: temperature, volume, and total energy.
...
def make_thermo_figure(results_list, labels, sim_dirs=None, tmax=None, 
    ...
    """Create figure with temperature, volume, and energy plots."""
    ...
    for (_group_title, idxs), sf in zip(temp_groups, subfigs):
        ...
        ax_temp, ax_vol, ax_energy = sf.subplots(
...
def main():
    ap = argparse.ArgumentParser(
        description="Plot thermodynamic properties (T, V, E) from MD trajectories",
